...
```shell title="Cloning the mod-data-training-centralasia repository inside data folder"
cd data
git clone https://github.com/agoenergy/mod-data-training-centralasia.git
cd ..
```
